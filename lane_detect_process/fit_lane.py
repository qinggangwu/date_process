...
if __name__ == '__main__':
    ...
    # read an image
    # i = Image.open("/home/wqg/pyproject/git/dbscan-python/img.gif")
    # i = i.convert("RGB")


    i = Image.open('/home/wqg/pyproject/git/lane/lanenet-lane-detection-pytorch/logwu/instance_output.jpg').convert("RGB")
    width, height = i.size
    ...
    newImg.save("/home/wqg/pyproject/git/dbscan-python/imgwu.jpg")
